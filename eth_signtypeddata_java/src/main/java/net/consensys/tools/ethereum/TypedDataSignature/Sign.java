...
/**
 * Copy of the Web3J class https://github.com/web3j/web3j/blob/master/crypto/src/main/java/org/web3j/crypto/Sign.java
 * Change: recoverFromSignature static function -> public
 *         
 * CAN BE REMOVED WHEN VERSION 3.3.2 WILL BE RELEASED (recoverFromSignature public)
 */
public class Sign {
